...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001934056027'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002667188714') # give your force subscribe channel id here else leave it blank
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mavimods2')
